...
HOW_TO_USE = [
    ...
    "A merged edit to data/clubs.json shows here at the next refresh that publishes, or sooner via a "
    "build_only=true dispatch. `python tools/clubs_review.py --dry-run --top 20` shows an edit's effect locally.",
